...
module.exports = __webpack_require__("8qzj");
...
async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    _helpers_axiosConfig__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].get(`/custom/style?fabric=${fabric}&collar=${collar}&cuff=${cuff}&sleeve=${sleeve}&bottom=${bottom}&chestpocket=${chestpocket}&pov=${pov}&placket=${placket}`).then(response => {
