...
module.exports = __webpack_require__("tOM1");
...
function handler(req, res) {
  if (req.method === "GET") {
    _helpers_axiosConfig__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].get("/detail_sub_style?name_style=Collar").then(response => {
      const {
        status,
        message
      } = response.data;
