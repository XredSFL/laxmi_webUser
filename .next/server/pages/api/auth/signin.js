...
module.exports = __webpack_require__("N3eh");
...
async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    _helpers_axiosConfig__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].post("/auth/login", {
      email: email,
      password: password
    }).then(response => {
      const {
      ...
      if (status) {
        ...
        const jsonDecode = jwt_decode__WEBPACK_IMPORTED_MODULE_1___default()(token);
