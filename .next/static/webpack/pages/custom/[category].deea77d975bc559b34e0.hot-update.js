...
var ModelContainer = function ModelContainer(_ref) {
  ...
  var _useHookCustom = Object(_hookCustom__WEBPACK_IMPORTED_MODULE_5__["default"])(),
      openStyle = _useHookCustom.openStyle,
      listStyle = _useHookCustom.listStyle,
      fabricList = _useHookCustom.fabricList,
      styleSelect = _useHookCustom.styleSelect,
      fabricSelect = _useHookCustom.fabricSelect,
      pov = _useHookCustom.pov,
      updatePov = _useHookCustom.updatePov,
      setPov = _useHookCustom.setPov,
      setDataStyle = _useHookCustom.setDataStyle,
      setIsLoading = _useHookCustom.setIsLoading,
      setOpenStyle = _useHookCustom.setOpenStyle,
      setFabricList = _useHookCustom.setFabricList,
      setStyleSelect = _useHookCustom.setStyleSelect,
      setFabricSelect = _useHookCustom.setFabricSelect,
      setIsLoadingFabric = _useHookCustom.setIsLoadingFabric; // Array containing the possible values
...
_s(ModelContainer, "HUwzm8Oq46RLP9jm00FWtRakMaA=", false, function () {
